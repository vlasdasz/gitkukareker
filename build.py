...
def build_android():
    ...
    try:
        os.symlink(this_path + "/target/aarch64-linux-android/release/liblabirintas.so",
                   "mobile/android/app/src/main/jniLibs/arm64-v8a/liblabirintas.so")
        os.symlink(this_path + "/target/armv7-linux-androideabi/release/liblabirintas.so",
                   "mobile/android/app/src/main/jniLibs/armeabi-v7a/liblabirintas.so")
...
def build_ios():
    ...
    run("xcodebuild -sdk iphonesimulator -scheme Labirintas build")
